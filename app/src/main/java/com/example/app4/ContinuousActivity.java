    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bttn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent = new Intent(ContinuousActivity.this,
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.arg1 == 1) {
                if (howFar == SUCCESS) {
                    ...
                    wt2.workerHandler2.removeCallbacksAndMessages(null);
                    mainHandler.removeCallbacksAndMessages(null);
                    Toast.makeText(ContinuousActivity.this, "Thread 1 wins", Toast.LENGTH_SHORT).show();
                } else {
                ...
                if (howFar == SUCCESS) {
                    ...
                    wt2.workerHandler2.removeCallbacksAndMessages(null);
                    mainHandler.removeCallbacksAndMessages(null);
                    Toast.makeText(ContinuousActivity.this, "Thread 2 wins", Toast.LENGTH_SHORT).show();
                }
                else {
                    Message m = new Message();
                    m.arg1 = msg.arg2;
